    ...
    for loc_key in ["gurgaon"]:
        ...
        for _ in range(50):
            ...
            user = {
                ...
                "flatmates_move_in_timeline": random.choice(MOVE_IN_TIMELINES) if is_flatmate else None,
                ...
                "flatmates_smoking": random.choice(SMOKING_LEVELS) if is_flatmate else None,
                "flatmates_drinking": random.choice(DRINKING_LEVELS) if is_flatmate else None,
